...
public class HandEvaluator implements Comparable<HandEvaluator>{
        ...
        if(this.rank != t.getRank())
            ...
            switch(this.rank){
                ...
                case 6://Flush
                    comparacion = comparaDos(t, 4);
                    int i = 3;
                    while(comparacion==0 && i >= 0){
                        comparacion = comparaDos(t, i);
                        i--;
                    }
                    return comparacion;
                case 7://Full
                ...
                case 8://Poker
                    ...
                    if (comparacion != 0) {
                       ...
                       /* System.out.println("1 " + this.getCartas().toString());
                        System.out.println("1 " + this.toString());
                        System.out.println("2 " + t.getCartas().toString());
    ...
    private int comparaDos(HandEvaluator t, int pos){
        return t.getCartasJugada().get(pos).getRank() - 
                this.cartasJugada.get(pos).getRank();
    }    
    ...
    private int compareKicker(HandEvaluator t, int kickers) {
        ...
        boolean diff = false;
        while(i > 0 && !diff){
            if(kicker.get(i).getValue()!=t.getKicker().get(i).getValue())
                diff = true;
            else
                i--;
        }
